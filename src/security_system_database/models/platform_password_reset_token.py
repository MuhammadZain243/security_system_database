"""Platform password reset token model."""
...
class PlatformPasswordResetToken(Base, UUIDPrimaryKeyMixin):
    """Short-lived password reset token for a platform user."""
    ...
    __table_args__ = (
        ...
        Index("ix_platform_password_reset_tokens_expires_at", "expires_at"),
        Index(
